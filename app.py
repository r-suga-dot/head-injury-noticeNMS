...
/* 文字背景の透明度を少し上げて画像を透かす */
.highlight { background-color: rgba(255, 255, 255, 0.75); padding: 15px; font-size: 1.1em; line-height: 1.6; color: #000; border-radius: 8px; border: 1px solid rgba(255,255,255,0.3); }
